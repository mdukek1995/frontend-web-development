...
})({"f7nhv":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "812cac2a0f2d9ef8";
...
},{}],"9xDde":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _animejs = require("animejs");
var _animejsDefault = parcelHelpers.interopDefault(_animejs);
var _letterizejs = require("letterizejs");
var _letterizejsDefault = parcelHelpers.interopDefault(_letterizejs);
const test = new (0, _letterizejsDefault.default)({
    targets: ".animate-me"
});
...
svg.addEventListener("load", function() {
    ...
    soldier.addEventListener("click", (e)=>{
        ...
        const soldierSelection = (0, _animejsDefault.default)({
            targets: soldier,
            translateX: [
                tranX,
                centerX
    ...
    sexual.addEventListener("click", (e)=>{
        ...
        tranY = e.clientY;
        const sSelection = (0, _animejsDefault.default)({
            targets: sexual,
            translateX: tranX,
            translateY: [
                tranY,
    ...
    marriage.addEventListener("click", (e)=>{
        tranX = centerX - e.clientX;
        tranY = centerY - e.clientY;
        const marriageSelection = (0, _animejsDefault.default)({
            targets: marriage,
            translateX: tranX,
            translateY: tranY,
            duration: 3000,
    ...
    begging.addEventListener("click", (e)=>{
        tranX = centerX - e.clientX;
        tranY = centerY - e.clientY;
        const beggingSelection = (0, _animejsDefault.default)({
            targets: begging,
            translateX: tranX,
            translateY: tranY,
            duration: 3000,
    ...
    organs.addEventListener("click", (e)=>{
        ...
        const organSelection = (0, _animejsDefault.default)({
            targets: organs,
            translateX: tranX,
            translateY: [
                tranY,
    ...
    domestic.addEventListener("click", (e)=>{
        tranX = centerX - e.clientX;
        tranY = centerY - e.clientY;
        const domesticSelection = (0, _animejsDefault.default)({
            targets: domestic,
            translateX: tranX,
            translateY: tranY,
            duration: 3000,
    ...
    debt.addEventListener("click", (e)=>{
        tranX = centerX - e.clientX;
        tranY = centerY - e.clientY;
        const debtSelection = (0, _animejsDefault.default)({
            targets: debt,
            translateX: tranX,
            translateY: tranY,
            duration: 3000,
    ...
    labor.addEventListener("click", (e)=>{
        tranX = e.clientX;
        tranY = centerY - e.clientY;
        const laborSelection = (0, _animejsDefault.default)({
            targets: labor,
            translateX: [
                tranX,
                centerX
...
},{"animejs":"jokr5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","letterizejs":"eR4xW"}],"jokr5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"eR4xW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * letterize.js v2.0.0
 ...
 */ /*jshint esversion: 6 */ const getTargets = (targets)=>{
    if (targets instanceof NodeList || targets instanceof HTMLCollection || Array.isArray(targets)) return targets;
    else if (targets instanceof HTMLElement) return [
        targets
    ];
    else if (typeof targets === "string") return document.querySelectorAll(targets);
    return null;
};
...
const deconstructObjects = (targets, target, wrapper, className, list, listAll, i, id)=>{
    if (!Array.isArray(target.letterize_id)) target.letterize_id = [];
    if (!target.letterize_id.includes(id)) {
        ...
        for(let j = 0; j < nodeListLength; j++){
            ...
            switch(nodeList[j].nodeType){
                case 1:
                    if (Array.prototype.indexOf.call(targets, nodeList[j]) === -1) // Check if current nodeList[j] wasn't deconstructed (it can happen if a target node is in another target node).
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["f7nhv","9xDde"], "9xDde", "parcelRequire4e05")

//# sourceMappingURL=index.0f2d9ef8.js.map
